...
sys.path.append(Get_Root_Path()+"RefineDet/python")
...
def main(args):
    ...
    save_dir = Get_Root_Path() + "models/{}/{}".format(dataset_name, job_name)
    # Directory which stores the snapshot of models.
    snapshot_dir = Get_Root_Path() + "models/{}/{}".format(dataset_name, job_name)
    # Directory which stores the job script and log file.
    job_dir = Get_Root_Path() + "models/jobdir/{}/{}".format(dataset_name, job_name)
    # Directory which stores the detection results.

    output_result_dir = "results/{}/".format(dataset_name)
    ...
    name_size_file = job_file + "/test_name_size.txt".format(dataset_name)
    # The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
    pretrain_model = Get_Root_Path() + "checkpoints/caffe_model/VGG_ILSVRC_16_layers_fc_reduced.caffemodel"
    # Stores LabelMapItem.
    label_map_file = Get_Root_Path() + "label_map/{}/labelmap_{}.prototxt".format(dataset_name, dataset_name)
    ...
    mbox_layers = CreateRefineDetHead(net, data_layer='data', from_layers=arm_source_layers,
                                      ...
                                      from_layers2=odm_source_layers)
    ...
    with open(job_file, 'w') as f:
        f.write('cd {}\n'.format(caffe_root))
        f.write('/home/jade/RefineDet/build/tools/caffe train \\\n')
        f.write('--solver="{}" \\\n'.format(solver_file))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str, default=Get_Root_Path() + "Data/HandGesture/Hand_Gesture/lmdb/Hand_Gesture_train_lmdb", help='the path of traindatapath')
    parser.add_argument('--test_data_path', type=str, default=Get_Root_Path() + "Data/HandGesture/Hand_Gesture/lmdb/Hand_Gesture_test_lmdb", help='the path of testdatapath')
    parser.add_argument('--dataset_name', type=str, default="HAND_GESTURE_320_" + GetToday(), help='save name')
